...
const MobileOrderDetail: React.FC<SelectedOrderProps> = ({
  ...
  const handleItemComplete = (item: any) => {
    if (!updateOrderItemStatus) return;
    updateOrderItemStatus(
      selectedOrder._id,
      item.id,
                ...
                {selectedOrder.items.map((item, index) => (
                  <IonItem key={index}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      {!item.completedAt && updateOrderItemStatus && (
                        <IonButton
                          size='small'
...
const OrderSummary: React.FC<{ selectedOrder: Order }> = ({ selectedOrder }) => (
...
const OrderPaymentDetails: React.FC<{ selectedOrder: Order }> = ({ selectedOrder }) => (
  <IonCard>
    <IonCardContent className='ion-text-center'>
      <IonGrid>
        <IonRow>
...
const OrderTimeline: React.FC<{ selectedOrder: Order }> = ({ selectedOrder }) => (
  <IonCard>
    <IonCardContent>
